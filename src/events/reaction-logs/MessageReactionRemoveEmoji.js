/**
 * @module events/reaction-logs/MessageReactionRemoveEmoji
 */
...
module.exports = {
    name: Discord.Events.MessageReactionRemoveEmoji,
    once: false,
    /**
     * @async
        ...
        try {
            ...
            let embed = new Discord.EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '**Reaction Emoji Name:**', value: emoji.name, inline: true },
            ...
            console.error(colors.red('Error handling messageReactionRemoveEmoji event:', error));
        }
    },
};
