/**
 * @module events/reaction-logs/MessageReactionAdd
 */
        ...
        try {
            ...
            let embed = new Discord.EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '**Time of Reaction:**', value: `<t:${Math.floor(Date.now() / 1000)}:F>` }
                )
                .setTimestamp();
            ...
            if (hasEmbeds) {
                ...
                try {
                    ...
                    const thread = await logMessage.startThread({
                        name: `Reaction Add - ${reactionUser}`,
            ...
            console.error(colors.red('Error handling messageReactionAdd event:', error));
        }
    },
};
