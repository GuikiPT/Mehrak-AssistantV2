    ...
    data: new Discord.SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                ...
                .setDescription('Scan all messages in the configured channel for matching stickers.')
        ),
        ...
        try {
            ...
            if (!interaction.replied && !interaction.deferred) {
                await interaction.reply({
                    content: `❌ An error occurred while executing the command: ${error.message || 'Unknown error'}`,
